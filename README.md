# Sitio Web - Angular 21 Modern Stack

Aplicación web moderna construida con Angular 21, enfoque zoneless, y despliegue automático a Firebase.
...
# Ejecutar contenedor
docker run -p 4000:4000 sitio-web
```
...
- **SSR obligatorio**: Para SEO y performance
